        ...
        <div class="container">
            <div class="row">
                ...
                <form class="row" action="" method="post">
                    ...
                    <div class="col-6">
                        <button type="submit" name="show" class="btn bg-secondary text-white form-control show-jokes">Search Jokes</button>
                    </div>
                </form>
                </div>
                <div class="col-3">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="card-title d-flex justify-content-between">
                                    ...
                                    <form action="" method="post">
                                        <input type="hidden" name="id-card" id="id-card" value="<?= $row["id"] ?>">
                                        <div class="buttons">
                                            <button type="submit" name="delete" class="delete-joke btn bg-danger px-2 py-1" onclick="deleteJoke()">
                                                <i class="fa-solid fa-trash text-white"></i>
                                            </button>
                                            <a href="#modal-task" data-bs-toggle="modal">
                                                <button name="update-joke" class="update-joke btn bg-info px-2 py-1" onclick="editjock(<?= $row['id'].',\''.$row['name'].'\',\''.$row['content'].'\'' ?>);">
